...
function setup(){
  ...
  ciclistaPrincipal.setCollider("rectangle", 0, 0, width, width);
...
function draw() {
  ...
  if(estadoJogo===JOGAR){
    ...
    text("aperte a seta direcional para cima (UP) para reiniciar o jogo", 400,  200);
...
function ciclistaVermelho(){
        jogador3 =createSprite(1300,Math.round(random(50, 250)));
        jogador3.scale =0.06;
